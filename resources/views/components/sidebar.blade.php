<div class="flex items-center gap-3 my-2">
    <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar"
        type="button" class="inline-flex items-center text-sm text-gray-300 sm:hidden">
    ...
    <a href="/" class="w-24 sm:hidden">
        <img src="{{ asset('images/doko_logo.svg') }}" alt="doko_logo">
    </a>
</div>
<aside id="default-sidebar" class="fixed z-40 w-64 transition-transform -translate-x-full h-screen sm:translate-x-0"
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-[#14161e]">
