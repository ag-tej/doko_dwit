                    ...
                    <div class="text-4xl leading-snug font-bold text-gray-300">
                        <div class="h-[50px] overflow-hidden">
                            <span class="relative animate-textChange">
                                <span style="color:#FF8515">your digital companion.</span><br>
                                <span style="color:#4DAF00">a symbol of unity.</span><br>
                                <span style="color:#0091BF">a basket of knowledge.</span><br>
                                <span style="color:#FF8515">a portal of possibilities.</span><br>
                            </span>
                        </div>
                    </div>
                    <p class="mt-4 text-base font-medium">you'll see me throughout your educational voyage</p>
                </div>
            </div>
        </section>
        {{-- cards section --}}
